        ...
        <ul className={styles.PeopleCallout}>
          ...
          {this.props.person.email &&
            <li id="personcopyemail">
              ...
              {/* <Icon iconName='Copy' title={strings.CopyEmailLabel} onClick={this._onCopyClicked('personcopyemail')} /> */}
            </li>
          }
          {this.props.person.phone &&
            <li id="personcopyphone">
              ...
              {/* <Icon iconName='Copy' aria-hidden={true} title={strings.CopyPhoneLabel} onClick={this._onCopyClicked('personcopyphone')} /> */}
            </li>
          }
          {this.props.person.mobile &&
            <li id="personcopymobile">
              ...
              {/* <Icon iconName='Copy' aria-hidden={true} title={strings.CopyMobileLabel} onClick={this._onCopyClicked('personcopymobile')} /> */}
            </li>
          }
